...
> Generated: 2026-08-31T15:01:08Z
> Git ref: 6eb150ca
> CI run: 33404755700
...
| Must-pass gate event log | PASS | 1 | 53954 B | `tests/ext_conformance/reports/gate/must_pass_events.jsonl` |
| Per-extension failure dossiers | MISS | 0 | 0 B | `tests/ext_conformance/reports/dossiers` |
| Health & regression delta report | PASS | 3 | 80613 B | `tests/ext_conformance/reports/health_delta` |
...
- **PERF-3X lineage coherence contract** (invalid): PERF-3X lineage span exceeds 14 days for run_id '33404755700' (oldest=2026-05-12 19:26:24 UTC, newest=2026-08-31 15:01:07 UTC)
